...
The challenge preserves an HTTP authentication scheme that satisfies
[RFC 9110's token grammar](https://www.rfc-editor.org/rfc/rfc9110.html#section-11.1), following
[OAuth's matching-challenge requirement](https://www.rfc-editor.org/rfc/rfc6749.html#section-5.2).
...
Unused GitHub response bodies are cancelled without waiting for cleanup to
finish. Cleanup failure cannot change an established outcome or extend the
request deadline. Required revocation of a minted token remains awaited.

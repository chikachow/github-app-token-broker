...
used for verification. Both paths require a public key with verification usage
and an RSA modulus of at least 2048 bits when applicable. The cached set retains
every structurally valid key so verification still detects ambiguous matches.
